...
public class PersonTest {
	...
	public static void main(String[] args) {
		...
		// Q. Person.java 에서 기본 생성자를 주석 처리 후 위의 showInformation 메소드를 호출하였을 때 어떻게 되는지 확인해 봅시다.
		System.out.println("기본 생성자를 주석 처리하면 The conductor Person() is undefined 메시지가 출력됩니다.");
		System.out.println("----------------");
